...
### **[➡️ Programm direkt & lokal im Browser nutzen ⬅️](https://alexander-henkes.github.io/noten-und-abschlussrechner-sek-i-hamburg/)**
...
- **Noteneingabe**: Fächerliste mit Pflichtfächern und frei ergänzbaren Fächern.
...
- **Import/Export**: Noteneingaben als JSON speichern und laden.
...
1. Wählen Sie den angestrebten Abschluss.
2. Tragen Sie die Noten in den Fächern ein (Pflichtfächer zuerst).
3. Prognose und Durchschnitt werden automatisch aktualisiert.

### Import/Export

- **Speichern**: Erzeugt eine JSON-Datei mit den aktuellen Noten und Einstellungen.
- **Laden**: Stellt die Noten aus einer JSON-Datei wieder her.
...
Dieses Tool verarbeitet Noten lokal im Browser.
